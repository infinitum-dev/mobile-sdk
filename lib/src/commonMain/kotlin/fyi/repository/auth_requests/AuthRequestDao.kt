...
internal interface AuthRequestDao {
    ...
    fun addRequest(date: String, image: String, domain: String, appToken: String, optionalParameters: PhotoOptionalParameters.Builder)
...
internal class AuthRequestDaoImpl(val query: AuthRequestsQueries): AuthRequestDao {
    ...
    override fun addRequest(date: String, image: String, domain: String, appToken: String,  optionalParameters: PhotoOptionalParameters.Builder) {
