...
- (void)biometricAuthenticationPhotoB64:(NSString *)photoB64 onSuccess:(void (^)(NSString *))onSuccess onFailure:(void (^)(ISDKMErrorResponse *))onFailure optionalParametersBuilder:(ISDKMBiometricAuthOptionalParametersBuilder *)optionalParametersBuilder __attribute__((swift_name("biometricAuthentication(photoB64:onSuccess:onFailure:optionalParametersBuilder:)")));
@end;
...
- (instancetype)initWithMBaseUrl:(NSString *)mBaseUrl mNetworkService:(ISDKMNetworkService *)mNetworkService mRepository:(ISDKMRepository *)mRepository __attribute__((swift_name("init(mBaseUrl:mNetworkService:mRepository:)"))) __attribute__((objc_designated_initializer));
- (void)worklogUser_id:(NSString *)user_id worklog_type:(NSString *)worklog_type device_identity:(NSString *)device_identity action:(NSString *)action location_id:(NSString *)location_id onSuccess:(void (^)(NSString *))onSuccess onFailure:(void (^)(ISDKMErrorResponse *))onFailure __attribute__((swift_name("worklog(user_id:worklog_type:device_identity:action:location_id:onSuccess:onFailure:)")));
...
- (void)getAllUsersOnSuccess:(void (^)(NSString *))onSuccess onFailure:(void (^)(ISDKMErrorResponse *))onFailure __attribute__((swift_name("getAllUsers(onSuccess:onFailure:)")));
